...
<!-- ページタイトルを入力 -->
@section('title', '定休日（月）設定')

<!-- ページの見出しを入力 -->
@section('content_header')
<h1><span>【{{$clinical_item->name}}】</span>定休日（月）設定</h1>
@stop
@section('breadcrumb')
<ol class="breadcrumb">
...
<div class="card box-primary">
 <!-- form start -->
 <form action="add_holiday" method="post" id="form_holiday" class="add_holiday">
    {{ csrf_field() }}
		<div class="card-header">
			<h3 class="card-title">診療の定休日（月）設定</h3>
...
<div class="box-fixed-btn">
				<ul>
					<li><button class="btn btn-warning btn-lg btn-save" data-form="form_holiday">設定</button></li>
				</ul>
			</div>
