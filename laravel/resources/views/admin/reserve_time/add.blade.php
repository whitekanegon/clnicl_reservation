...
<div class="card box-primary">
 <!-- form start -->
 <form action="add" method="post" id="form_reserveTime_add">
		<div class="card-header">
			<h3 class="card-title">予約時間帯名</h3>
		</div>
  <div class="card-body">
    {{ csrf_field() }}
   <div class="add_reserveTimes addedline">
   <div class="form-group">
   <input type="text" name="name[]" class="form-control inline validItems">
